#!/bin/sh
# Regenerate src/Tables.mw and src/Cases.mw from the unicode-segmentation crate.
#
#   scripts/generate.sh
#
# The crate version is pinned in scripts/generate/Cargo.toml. To move to a new
# one, change the pin and run this: if the crate's segmentation rules have changed,
